...
public class User {
    ...
    @Column(unique = true, nullable = false, length = 20) // unique 제약조건
    private String username;

    @JsonIgnore // 노출되지 않기 위해서
    @Column(nullable = false, length = 60) // 60Byte: 단방향 암호화(60자 이상)
    ...
    // 권한 변경 (관리자)
    public void updateRole(String role) { // 의미있는 setter로 role 바꾸기
